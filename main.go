		...
		&info.InfoImpl{
			Info: &plugin.PluginInfo{
				...
				Parameters: []*plugin.ParameterInfo{
					...
					{Name: snowflake.SfApplications, Description: "If set, applications will be fetched.", Mandatory: false},
					...
					{Name: snowflake.SfUsageUserExcludes, Description: "This comma separated list of regular expressions can be used to exclude users from the data usage sync. e.g. 'RAITO_.+,SYSTEM_.+' will match any user whose name starts with 'RAITO_' or 'SYSTEM_', meaning their usage statements will be skipped. This is typically used for service accounts that do a large amount of operations.", Mandatory: false},
