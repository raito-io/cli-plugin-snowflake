...
func (_m *mockDataUsageRepository) GetUsers() ([]UserEntity, error) {
	ret := _m.Called()
...
// mockDataUsageRepository_GetUsers_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetUsers'
type mockDataUsageRepository_GetUsers_Call struct {
	*mock.Call
}

// GetUsers is a helper method to define mock.On call
func (_e *mockDataUsageRepository_Expecter) GetUsers() *mockDataUsageRepository_GetUsers_Call {
	return &mockDataUsageRepository_GetUsers_Call{Call: _e.mock.On("GetUsers")}
}

func (_c *mockDataUsageRepository_GetUsers_Call) Run(run func()) *mockDataUsageRepository_GetUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockDataUsageRepository_GetUsers_Call) Return(_a0 []UserEntity, _a1 error) *mockDataUsageRepository_GetUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockDataUsageRepository_GetUsers_Call) RunAndReturn(run func() ([]UserEntity, error)) *mockDataUsageRepository_GetUsers_Call {
	_c.Call.Return(run)
	return _c
}
