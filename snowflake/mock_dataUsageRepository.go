...
type mockConstructorTestingTnewMockDataUsageRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockDataUsageRepository(t mockConstructorTestingTnewMockDataUsageRepository) *mockDataUsageRepository {
